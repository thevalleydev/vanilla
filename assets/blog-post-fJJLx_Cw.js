import{A as o,E as d,L as u,F as c,H as x,N as h,b as a,D as p,a as i,u as b}from"./Navigation-B3dD36qV.js";import{u as m,a as g}from"./index-DyMvCeu2.js";const v={CHILD:2},f=r=>(...t)=>({_$litDirective$:r,values:t});class ${constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,s){this._$Ct=t,this._$AM=e,this._$Ci=s}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}class l extends ${constructor(t){if(super(t),this.it=o,t.type!==v.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===o||t==null)return this._t=void 0,this.it=t;if(t===d)return t;if(typeof t!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}l.directiveName="unsafeHTML",l.resultType=1;const k=f(l);function y(){const r=m(),{getPostBySlug:t}=g(),e=r.currentRoute.value.path.split("/")[2],s=t(e);return s?(b(s.title),a`
